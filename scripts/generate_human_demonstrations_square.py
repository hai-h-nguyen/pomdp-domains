...
parser.add_argument("--rot-scale", type=float, default=1.0, help="How much to scale rotation user inputs")
...
parser.add_argument("--domain", type=str, help="Domain to run", default="square")

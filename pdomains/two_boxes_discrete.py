...
class BoxEnv(gym.Env):
    ...
    def __init__(self, rendering=False, seed=None):
        ...
        self.state_space = spaces.Box(low=-float('inf'), high=float('inf'), shape=(2,), dtype=np.float32)
    ...
    def query_state(self):
        return np.array((self.x_g / self.x_right_limit, self.go_to_left))
    ...
    def step(self, action):
        ...
        info["success"] = reached_heaven

        return self._get_obs(), env_reward, done, info
